...
import StakingModal from '../../../components/Staking/Pools/StakingModal'
import AwaitingRewards from '../../../components/Staking/Pools/AwaitingRewards'
import { useDefaultStakingPools } from '../../../state/stake/hooks'
import ModifiedUnstakingModal from '../../../components/Staking/Pools/ModifiedUnstakingModal'
import ClaimRewardModal from '../../../components/Staking/Pools/ClaimRewardModal'
...
export default function Manage({
  ...
  let stakingInfo = useDefaultStakingPools(undefined, stakingTokenPair)?.[0]
  ...
  return (
    <PageWrapper gap="lg" justify="center">
      ...
      {stakingInfo && (stakingInfo.valueOfTotalStakedAmountInUsd || stakingInfo.poolRewardsPerBlock) && (
      ...
      {stakingInfo && stakingInfo.active && showAddLiquidityButton && (
        <VoteCard>
          <CardBGImage />
          <CardNoise />
          <CardSection>
        ...
        <>
          {rewardsStarted && (
            <TYPE.main style={{ textAlign: 'center' }} fontSize={14}>
              ...
              <br />
              when claiming {stakingSettings?.lockRewardsRatio}% will be locked and{' '}
              {stakingSettings?.unlockedRewardsRatio}% will be immediately accessible.
            </TYPE.main>
          )}
        </>
        <AwaitingRewards />
