...
export default function EarnArchived() {
  ...
  const stakingInfos = useDefaultStakingPools(false)
  ...
  const inactiveStakingInfos = useFilterDefaultStakingPools(stakingInfos, false)

  let poolsToDisplay = inactiveStakingInfos
    ...
    <PageWrapper gap="lg" justify="center">
        ...
        <ExtraDataCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              ...
              <RowBetween>
                <StyledInternalLink to={`/staking/pools`}>
      ...
      <AutoColumn gap="lg" style={{ width: '100%', maxWidth: '720px' }}>
        <RowBetween style={{ alignItems: 'baseline' }}>
          <TYPE.mediumHeader style={{ marginTop: '0.5rem' }}>Pools - archived</TYPE.mediumHeader>
          <CombinedTVL />
        </RowBetween>
