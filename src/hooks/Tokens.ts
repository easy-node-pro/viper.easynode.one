...
import { Currency, Token, currencyEquals } from '@venomswap/sdk'
...
import { BLOCKED_TOKENS } from '../constants'
...
export function useToken(tokenAddress?: string): Token | undefined | null {
  ...
  return useMemo(() => {
    if (address && BLOCKED_TOKENS.includes(address.toLowerCase())) return undefined
...
export function useCurrency(currencyId: string | undefined): Currency | null | undefined {
  const isETH = currencyId?.toUpperCase() === BASE_CURRENCY.symbol
